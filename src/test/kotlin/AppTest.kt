...
class EncodingTest : FunSpec({
    ...
    test("A message should allow emoji") { testMessage(TextMessage("message \uD83D\uDCDA")) }

    test("A message should allow using multiple languages") {
        testMessage(TextMessage("Japanese: 日 Chinese: 传/傳 Kannada: ಘ"))
    }
})
