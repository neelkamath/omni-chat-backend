...
import graphql.operations.mutations.*
...
import graphql.operations.subscriptions.parseFrameError
...
const val MESSAGE_UPDATES_QUERY = """
...
fun errMessageUpdates(accessToken: String, chatId: Int, exception: GraphQlDocDataException): Unit =
