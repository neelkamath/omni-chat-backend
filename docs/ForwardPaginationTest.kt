class ForwardPaginationTest : FunSpec({
    ...
    test(
        ...
        then the number of items specified by the limit should be returned from after the cursor
        """
    ) {
    ...
    test(
        ...
        when retrieving items, 
        then the number of items specified by the limit from the first item should be retrieved
        """
    ) {
    ...
    test(
        ...
        when retrieving items, 
        then every item after the cursor should be retrieved
        """
    ) {
