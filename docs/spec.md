...
- Public chats should be indexable by search engines so that users without an account can search for messages, etc. Omni Chat can be run by anyone, and so certain instances may want to disallow indexing due to secrecy.
